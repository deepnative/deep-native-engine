...
def verify_application(root):
    ...
    require(report["exitStatus"] == 0 and report["scope"] == "initial-learning-v14", "Application verification failed or wrong scope")
...
def verify(root):
    report = {"scope": "repository-and-initial-learning-v14", "application_status": "not-verified",
