...
Bootstrap installs the repository's pre-push hook. Verification checks the preserved source, planning references, agent/skill definitions, and tooling behavior. A passed check does **not** claim application unit or E2E coverage. See [verification scope](assets/docs/workflows/VERIFICATION.md).
