...
Current authorization includes the [initial local learning slice](../INITIAL-LEARNING-SLICE.md) explicitly confirmed by the owner under #1. Deployment, live integrations and broader backlog execution require their own scope.
