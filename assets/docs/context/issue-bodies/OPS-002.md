...
Deliver the optional five-member coached pilot with measured learning outcomes.
...
- [ ] For the optional coached-pilot experiment, admit five actual paying members with different relevant backgrounds/goals only after go-live authorization, accepted scope and reserved qualified capacity. Contractor or employment status is not an admission prerequisite.
...
- [ ] Assess useful learning/project outcomes against member goals, including suitable noncoding work. Do not require a contract win, job placement or income increase to count a legitimate learning outcome.
