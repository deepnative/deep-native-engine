...
The source strings, family IDs, case IDs, source links, issue links and critical flags are unchanged by this subcase audit. This is a correction to proposed case semantics within `full-mvp-v1`, before approval. Its SHA-256 mapping digest is `581083999c08f794b3814470a2e2a708f3708ff0ea6dd9785999ce5a1bdf3a45`; this is a fingerprint of the proposal, **not** an approval. The preceding digests `0345855e5b331e2be1a4403a27f6af0128e0a1c3b83f9d50abaaef7bc623be81` and `14963de159ede2a79d43b963d0d7c974fc124538c7738ea1c36933fb90850631` no longer identify this mapping. The #158 independent review requested this change rather than approving the previous mapping. A new separate technical reviewer must compare the revised 206 checks to all three sources and the browser evidence rule, record findings and a decision on #94, and only then may a reviewed change move the approval file out of `pending`. The author’s review of this correction does not supply that separate decision.
