...
it("requires ROADMAP-01-B/02-A/B/C/D/08-A/B, ECO-01 to ECO-04, ECO-06-A and BUILD-02-A/C/D/08-A/B/C/10-A/B provisional browser evidence without approving release", () => {
  const ids = [
    "F-ROADMAP-02-A",
    "F-ROADMAP-02-B",
    "F-ROADMAP-02-D",
  ...
  expect(assertProvisionalReleaseJourneys(proposal, report)).toMatchObject({
    ...
    criticalPassed: 20,
    criticalTotal: 20,
    executions: 26 * proposal.projects.length,
  });
  for (const [browserIndex, browserName] of proposal.projects.entries()) {
