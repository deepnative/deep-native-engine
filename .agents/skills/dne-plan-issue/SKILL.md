...
6. Return a ready-to-review issue proposal and unresolved decisions. For the handoff, name one next bounded live issue or owner decision, why it is next, and its lead model/starting effort from live labels or routing policy; include separate design/review recommendations and blockers where relevant. Do not claim or start the recommended work. Write to GitHub only when authorized; re-read the latest body and preserve unrelated edits. Never claim completion of unexecuted work.
