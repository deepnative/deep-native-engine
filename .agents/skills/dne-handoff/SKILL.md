...
5. Produce the [evidence record](../../../assets/docs/templates/EVIDENCE.md) and [handoff](../../../assets/docs/templates/HANDOFF.md). Write requested docs only; publishing, pushing, merging, closing issues or deployment require authorization in the task. Re-read live state before authorized updates.
